...
import 'package:flutter_task_planner_app/widgets/task_widget/Tesktile.dart';
...
class AllTaskPage extends StatefulWidget {
  int? indexs;
  AllTaskPage({Key? key, this.indexs}) : super(key: key);
...
class _AllTaskPageState extends State<AllTaskPage> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      print("Initialize with index: $selectedIndex");
        ...
        IconButton(
            onPressed: () {
              ...
              notifyHelper.displayNotification(
                  title: "Theme", body: 'Theme switched');
