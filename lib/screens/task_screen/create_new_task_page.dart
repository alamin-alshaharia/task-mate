...
class CreateNewTaskPage extends StatefulWidget {
  ...
  const CreateNewTaskPage({Key? key, this.preSelectedCategory})
      : super(key: key);
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: FutureBuilder<List<CategoryModel>>(
          future: _taskController.getCategories(),
                                    ...
                                    return GestureDetector(
                                      ...
                                      child: Chip(
                                        ...
                                        labelStyle: TextStyle(
                                          color: _selectedCategoryIndex.value ==
                                                  index
                                              ? Colors.white
                                              : Colors.black87,
                                        ),
  ...
  _addTaskToDb() async {
    int value = await _taskController.addTask(
      task: Task(
        ...
        categoryId:
            _taskController.categoryList[_selectedCategoryIndex.value].id!,
      ),
    );
